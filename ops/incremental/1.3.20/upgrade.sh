...
if [ "$MODE" = docker ]; then
  ...
  docker exec "$CTR" /opt/material_matcher/current/runtime/bin/python3 /tmp/sync_meta.py 1.3.20
  ...
  /opt/material_matcher/current/runtime/bin/python3 scripts/sync_meta.py 1.3.20
