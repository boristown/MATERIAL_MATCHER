...
def test_builder_plan_covers_manual_layout() -> None:
    ...
    for target in ("run.sh", "menu.sh", "doc.md", "README.md", "rst.sh", "stop.sh", "del.sh", "bk.sh", "clean.sh", "guide.docx", "test.docx", "安装物料集团码智能匹配平台.desktop", "docs/doc.md", "docs/ops.md", "docs/faq.md", "use.md", "docs/use.md"):
